...
public class CustomGame extends JFrame implements ActionListener {
	...
	CustomGame() {
		...
		btn1.addActionListener(new StartGame());
		pnl1.add(lbl1);
		pnl1.add(txt1);
		pnl1.add(lbl6);
		pnl1.add(txt6);
	...
	class StartGame implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			setVisible(false);
			int sizeX = Integer.parseInt(txt1.getText());
			int sizeY = Integer.parseInt(txt6.getText());
			int colors = Integer.parseInt(txt2.getText());
			int x = Integer.parseInt(txt3.getText());
				int y = Integer.parseInt(txt4.getText());
			int delay = Integer.parseInt(txt5.getText());
			int duration = Integer.parseInt(txt7.getText());
